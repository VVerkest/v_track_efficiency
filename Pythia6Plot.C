void Pythia6Plot(){
  ...
  string inFileName = "out/pythia6TrackEfficiency_"; 
  inFileName += particleSettings;    inFileName += ".root";
  string fileSaveName = "histos/pythia6TrackEfficiency_";
  ...
  //  gather histograms
  TH3D* h_all_EtaPhiPt = (TH3D*) pythia6FILE->Get("all_EtaPhiPt");                          //h_all_EtaPhiPt->Write();
  TH3D* h_allcons_EtaPhiPt = (TH3D*) pythia6FILE->Get("allcons_EtaPhiPt");           //h_allcons_EtaPhiPt->Write();
  TH3D* h_lead_EtaPhiPt = (TH3D*) pythia6FILE->Get("lead_EtaPhiPt");                     //h_lead_EtaPhiPt->Write();
  TH3D* h_leadcons_EtaPhiPt = (TH3D*) pythia6FILE->Get("leadcons_EtaPhiPt");      //h_leadcons_EtaPhiPt->Write();
